...
// and OS code and the system stack occupies 60 positions 
	...
	readyToRunQueue[0][0] = (heapItem *) malloc(PROCESSTABLEMAXSIZE*sizeof(heapItem));
	readyToRunQueue[1][0] = (heapItem *) malloc(PROCESSTABLEMAXSIZE*sizeof(heapItem));
...
int OperatingSystem_CreateProcess(int indexOfExecutableProgram) {
	...
	if(programFile == PROGRAMDOESNOTEXIST){
...
void OperatingSystem_PrintReadyToRunQueue(){
	...
	ComputerSystem_DebugMessage(108, SHORTTERMSCHEDULE, "\n");
	ComputerSystem_DebugMessage(108, SHORTTERMSCHEDULE, "\t");
	ComputerSystem_DebugMessage(108, SHORTTERMSCHEDULE, "DAEMON");
