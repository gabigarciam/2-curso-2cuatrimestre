...
// and OS code and the system stack occupies 60 positions 
	...
	//readyToRunQueue[USERPROGRAM] = (heapItem *) malloc(PROCESSTABLEMAXSIZE*sizeof(heapItem));
	//readyToRunQueue[DAEMONPROGRAM] = (heapItem *) malloc(PROCESSTABLEMAXSIZE*sizeof(heapItem));
...
void OperatingSystem_PrintReadyToRunQueue(){
	...
	ComputerSystem_DebugMessage(108, SHORTTERMSCHEDULE, readyToRunQueue[0][numberOfReadyToRunProcesses[0]-1 ].info, 
		processTable[readyToRunQueue[0][numberOfReadyToRunProcesses[0]-1].info].priority);
}
