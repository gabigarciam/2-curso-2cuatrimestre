...
namespace TPP.Laboratory.Functional.Lab07 {
    ...
    static public class Functions {
        ...
        /// <summary>
        /// método extensor de colección de enteros que convierte la propia colección 
        /// en un diccionario cuya clave de calcula con una función pasada como parámetro 
        /// y la clave es el propio número
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="collection"></param>
        /// <param name="a"></param>
        /// <returns></returns>
        public static Dictionary<T, int> ToDictionaryWithKeySelector<T>(this IEnumerable<int> collection, Func<int, T> func)
        {
            return collection.ToDictionary(func, number => number);
        }
